...
TypeScript development standards. Includes quality gates, atomic design structure, type safety, TDD patterns, and TypeScript-specific best practices.
...
TypeScript-specific quality checks (see testing/quality-gates.md for universal requirements):
...
TypeScript-specific atomic design patterns (see global/code-structure.md for complete hierarchy and rules):
...
TypeScript-specific TDD patterns (see testing/tdd-methodology.md for core TDD principles):
...
TypeScript-specific security patterns (see global/security.md for universal security requirements):
